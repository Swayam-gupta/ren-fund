...
class LiveTrader:
    ...
    def run(self) -> dict:
        ...
        while self._cycle < self.max_cycles:
            ...
            self._equity_log.append({
                ...
                "equity":      round(self.capital + self._reserved_margin(), 4),
    ...
    def _reserved_margin(self) -> float:
        """Sum of margin locked in all currently open positions."""
        return sum(info["pos"].margin for info in self.open_positions.values())
